...
#SBATCH -J gdas_base_darts # sets the job name. If not
echo "Workingdir: $PWD";
...
python scripts/baselines/gdas/gdas_search_and_discretize.py --search_epochs 100 --eval_epochs 600 --searchspace "darts"
